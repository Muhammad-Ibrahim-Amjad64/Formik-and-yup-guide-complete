...
// 7 th write a validation logic in 
...
//    const Formik = useFormik(  // second step
   const {handleChange,values,handleSubmit,handleBlur,errors,touched} = useFormik(  // 2nd step  destructering for clear code 
        {
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>      
      <div className="form-control">
        ...
        onBlur={handleBlur} />  
        {touched.email && errors.email ? <p style={invalitStyle}>{errors.email}</p>: ""}   
      ...
      <div className="form-control">
        ...
        //   5th step include these 3 values as it is in every input field 
         ...
         onChange={handleChange}
         onBlur={handleBlur} />                  
         {touched.password && errors.password ? <p style={invalitStyle}>{errors.password}</p>: ""}    
      </div>
      ...
      <div className="form-control">
        ...
        onChange={handleChange}
        onBlur={handleBlur} /> 
         {touched.confirmPassword && errors.confirmPassword ? <p style={invalitStyle}>{errors.confirmPassword}</p>: ""}        
                                  {/*must include name property  */}
      </div>
